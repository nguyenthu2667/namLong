    ...
    <b-card>
      ...
      >
        ...
        >
          ...
          <b-tab>
            <span class="title-category">NGHIỆP VỤ: CÁC LOẠI GIẤY TỜ RƠ MOOC</span>
            <form-detail
...
import FormDetail from "@/views/app/function/npl/du-lieu-dau-ky/component/FormDetailDataDateMooc.vue";
...
export default {
  ...
  computed: {
    ...
    FactorID() {
      ...
      if (path.includes("function") && path.includes("data-date-mooc")) {
        return "DataBegin";
      }
      return "";
    },
    ...
    handlePrint(obj) {
      switch (obj.PrintType.toUpperCase()) {
        case "DOWNLOAD":
          ...
          break;
        case "CLIENT":
          let formName = "Các loại giấy tờ rơ mooc";
          handling.printExcel(
