    ...
    <b-card>
      ...
      >
        ...
        >
          ...
          <b-tab>
            <span class="title-category">NGHIỆP VỤ: BẢO TRÌ, BẢO DƯỠNG RƠ MOOC</span>
            <form-detail
          ...
          <b-tab>
            <span class="title-category">QNGHIỆP VỤ: BẢO TRÌ, BẢO DƯỠNG RƠ MOOC</span>
            <form-history
...
import FormDetail from "@/views/app/function/npl/du-lieu-dau-ky/component/FormDetailDataMaintanceMooc.vue";
...
export default {
  ...
  computed: {
    ...
    FactorID() {
      ...
      if (path.includes("function") && path.includes("data-maintance-mooc")) {
        return "DataBegin";
      }
      return "";
    },
    ...
    handlePrint(obj) {
      switch (obj.PrintType.toUpperCase()) {
        case "DOWNLOAD":
          ...
          break;
        case "CLIENT":
          let formName = "BẢO TRÌ, BẢO DƯỠNG RƠ MOOC";
          handling.printExcel(
